    ...
    public class WrapLayout : Layout<View>
    {
        ...
        LayoutData GetLayoutData(double width, double height)
        {
            ...
            foreach (View child in Children)
            {
                ...
                maxChildSize.Width = 115;// Math.Max(maxChildSize.Width, childSizeRequest.Request.Width);
                maxChildSize.Height = 168;// Math.Max(maxChildSize.Height, childSizeRequest.Request.Height);
            }
